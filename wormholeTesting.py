...
ds=0.01
univ1=imageio.v2.imread('C:/Users/sam05/OneDrive/Desktop/CODE/github-repositorys/Wormholes/universes/univ3.jpg')
...
def segScreen(offset):
    ...
    for i in range(2*IMSIZE//(workers//2)):
        ...
        for j in range(2*IMSIZE//2):
            raydata=wormholes[0].traceRayFromLookup({'x':-10,'y':0,'z':0},unit_vector({'x':10,'y':-(i/2+offset['x'])*FOV/IMSIZE,'z':(j/2+offset['y'])*FOV/IMSIZE}),1,0)
            if raydata['univ']==0:
